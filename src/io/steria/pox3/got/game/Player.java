...
public class Player {
	...
	House house;
	ObjectiveCard card;
	PlayerState state = PlayerState.PLAYING; //0: in play, 1: won, 2: lost, 3: dead
	...
	/*public Player(String name, House house) { //on a généré le constructeur donc le super apparait
		super();
		this.name = name;
		this.house = house;
	}*/
	
	public Player(String name, House house) {//on a généré le constructeur en omettant le super
		this.name = name;
		this.house = house;
		//argh bidirectional
